...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static String POST(String url, Person person){
        ...
        try {
            ...
            jsonObject.accumulate("name", person.getCountry());
        ...
        switch(view.getId()){
            case R.id.btnPost:
                if(!validate())
                    ...
                    httpTask.execute("http://70.12.50.58:3000", etName.getText().toString(), etCountry.getText().toString(), etTwitter.getText().toString());
                }
                break;
        }
